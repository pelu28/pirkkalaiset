...
public class EhdokkaatClient extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd=request.getRequestDispatcher("./addehdokas.html");
        ...
        // TODO Auto-generated method stub
        String uri = "http://127.0.0.1:8080/rest/ehdokkaatservice/all";
        ...
        for (int i=0;i<returnedList.size();i++) {
            ...
            out.println(ehdokkaat+" <a href='./ehdokkaatclient?deleteId="+ehdokkaat.getId()+"'>Remove</a><br>");
        }
